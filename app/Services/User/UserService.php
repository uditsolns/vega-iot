...
readonly class UserService
{
    ...
    {
        $successCount = User::whereIn("id", $userIds)->update([
            "is_active" => true,
        ]);

        return [
            "success_count" => $successCount,
            "failed_count" => count($userIds) - $successCount,
        ];
    }
    ...
    {
        $successCount = User::whereIn("id", $userIds)->delete();
     ...
     * @return array
     */
    public function bulkChangeRole(array $userIds, int $roleId): array
    {
        $successCount = User::whereIn("id", $userIds)->update([
            "role_id" => $roleId,
        ]);
